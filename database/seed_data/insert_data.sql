...
INSERT INTO `componenttype` (name, description) VALUES
('CPU', 'Bộ vi xử lý'),
...
('AMD', 'Advanced Micro Devices - Nhà sản xuất CPU và GPU hàng đầu'),
('Intel', 'Nhà sản xuất CPU số 1 thế giới'),
('ASUS', 'Nhà sản xuất phần cứng và thiết bị điện tử đa dạng'),
('MSI', 'Micro-Star International - Chuyên sản xuất phần cứng gaming'),
('Gigabyte', 'Nhà sản xuất bo mạch chủ và card đồ họa chất lượng cao'),
('NVIDIA', 'Nhà sản xuất GPU hàng đầu thế giới'),
('Corsair', 'Chuyên các thiết bị gaming và PC cao cấp'),
('G.Skill', 'Nhà sản xuất RAM hiệu năng cao'),
('WD', 'Western Digital - Giải pháp lưu trữ chuyên nghiệp'),
('Samsung', 'Tập đoàn công nghệ đa quốc gia'),
('Noctua', 'Chuyên giải pháp tản nhiệt cao cấp'),
('Arctic', 'Giải pháp làm mát chuyên nghiệp'),
('Logitech', 'Thiết bị ngoại vi và gaming gear cao cấp'),
('Razer', 'Thương hiệu gaming gear hàng đầu'),
('Beyerdynamic', 'Âm thanh chuyên nghiệp từ Đức'),
('SteelSeries', 'Gaming gear cao cấp'),
('LG', 'Màn hình và thiết bị điện tử chất lượng cao'),
('Secretlab', 'Ghế gaming cao cấp'),
('Herman Miller', 'Ghế văn phòng chuyên nghiệp'),
('IKEA', 'Nội thất và thiết bị văn phòng'),
('Kingston', 'Giải pháp bộ nhớ và lưu trữ tin cậy'),
('Crucial', 'Bộ nhớ và lưu trữ hiệu năng cao'),
('Team Group', 'Nhà sản xuất RAM và SSD'),
('Patriot', 'Thiết bị lưu trữ và RAM gaming'),
('ADATA', 'Giải pháp lưu trữ và RAM đa dạng'),
('ASRock', 'Bo mạch chủ và card đồ họa giá tốt'),
('EVGA', 'Phần cứng gaming cao cấp'),
('Zotac', 'Card đồ họa nhỏ gọn'),
('Palit', 'Nhà sản xuất GPU giá tốt'),
('PowerColor', 'Card đồ họa AMD chuyên nghiệp'),
('Sapphire', 'Card đồ họa AMD cao cấp'),
('XFX', 'Thiết bị gaming chất lượng cao');

INSERT INTO `series` (brand_id, name, component_type_id, description) VALUES
(1, 'Ryzen 9000', 1, 'Dòng CPU cao cấp mới nhất của AMD'),
(2, 'Core Ultra 200', 1, 'CPU thế hệ mới với công nghệ hybrid'),
(3, 'ROG Strix', 2, 'Dòng bo mạch chủ cao cấp của ASUS'),
(5, 'Aorus Elite', 2, 'Bo mạch chủ gaming của Gigabyte'),
(7, 'Vengeance', 3, 'RAM hiệu năng cao của Corsair'),
(8, 'Trident Z5', 3, 'RAM DDR5 cao cấp của G.Skill'),
(6, 'GeForce RTX 50', 4, 'GPU thế hệ mới nhất của NVIDIA'),
(4, 'Radeon RX 9000', 4, 'GPU AMD do MSI sản xuất'),
(9, 'Black SN850X', 5, 'SSD NVMe hiệu năng cao'),
(10, '970 EVO Plus', 5, 'SSD NVMe đáng tin cậy'),
(7, 'RMx', 6, 'Nguồn modular cao cấp'),
(4, 'MPG', 6, 'Nguồn gaming của MSI'),
(3, 'Lancool', 7, 'Case tối ưu airflow'),
(5, 'Aorus C', 7, 'Case gaming cao cấp'),
(12, 'Liquid Freezer III', 8, 'Tản nhiệt nước All-in-one'),
(11, 'NH-U', 8, 'Tản nhiệt khí cao cấp'),
(13, 'G Pro', 9, 'Chuột gaming không dây'),
(14, 'DeathAdder', 9, 'Chuột gaming ergonomic'),
(13, 'Ornata', 10, 'Bàn phím cơ membrane'),
(14, 'BlackWidow', 10, 'Bàn phím cơ gaming'),
(15, 'DT 990', 11, 'Tai nghe studio open-back'),
(16, 'Arctis', 11, 'Tai nghe gaming không dây'),
(17, 'Odyssey', 12, 'Màn hình gaming cao cấp'),
(4, 'Optix', 12, 'Màn hình gaming MSI'),
(18, 'Titan Evo', 13, 'Ghế gaming cao cấp'),
(19, 'Sayl', 13, 'Ghế văn phòng ergonomic'),
(20, 'UPPSTÅ', 14, 'Bàn điều chỉnh độ cao'),
(20, 'LAGKAPTEN', 14, 'Bàn làm việc đa năng'),
(21, 'Fury Beast', 3, 'RAM DDR5 hiệu năng cao'),
(21, 'Fury Renegade', 3, 'RAM gaming cao cấp'),
(22, 'Ballistix', 3, 'RAM tối ưu cho gaming'),
(23, 'T-Force', 3, 'RAM RGB hiệu năng cao'),
(24, 'Viper', 3, 'RAM gaming tốc độ cao'),
(25, 'XPG', 3, 'RAM và SSD cao cấp'),
(2, 'Core i9-14000', 1, 'CPU Intel thế hệ 14'),
(2, 'Core i7-14000', 1, 'CPU Intel hiệu năng cao'),
(2, 'Core i5-14000', 1, 'CPU Intel giá/hiệu năng tốt'),
(1, 'Ryzen 7 8000', 1, 'CPU AMD 8 nhân mạnh mẽ'),
(1, 'Ryzen 5 8000', 1, 'CPU AMD phổ thông'),
(6, 'GeForce RTX 40', 4, 'GPU NVIDIA thế hệ trước'),
(1, 'Radeon RX 8000', 4, 'GPU AMD mới nhất'),
(27, 'GeForce RTX', 4, 'GPU NVIDIA by EVGA'),
(28, 'GeForce RTX', 4, 'GPU NVIDIA by Zotac'),
(29, 'GeForce RTX', 4, 'GPU NVIDIA by Palit'),
(30, 'Radeon RX', 4, 'GPU AMD by PowerColor'),
(31, 'Radeon RX', 4, 'GPU AMD by Sapphire'),
(32, 'Radeon RX', 4, 'GPU AMD by XFX');
