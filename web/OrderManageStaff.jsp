...
<html>
    <head>
        ...
        <style>
            ...
            .status-badge.readonly.completed {
                background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);
                color: white;
            }

            .status-badge.readonly.cancel {
                background: linear-gradient(135deg, #ff6b6b 0%, #ffa500 100%);
                color: white;
            }

            .status-badge.readonly.pending {
                background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);
                color: white;
            }

            .status-badge.readonly.shipping {
    ...
    <body>
        ...
        <div class="container my-5">
            ...
            <div class="filter-section">
                <form action="order-manage-staff" method="get" class="filter-form">
                                    ...
                                    <c:forEach items="${orders}" var="order" varStatus="status">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <c:choose>
                                                    <c:when test='${order.status == "Pending" || order.status == "Shipping"}'>
                                                        <select 
