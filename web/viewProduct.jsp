...
<html lang="en">
    ...
    <body>
        <div class="container-fluid mt-3" style="padding-left:0; margin-left:0; width:100%; max-width:100%;">
            ...
            <div id="uploadModal" style="display:none; position:fixed; top:30%; left:50%; transform:translate(-50%, -50%);
                 background:#fff; padding:20px; border:1px solid #ccc; z-index:1000;">
                <form method="post" action="${pageContext.request.contextPath}/ProductImportServlet" enctype="multipart/form-data">
