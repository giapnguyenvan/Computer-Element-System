...
public class VoucherDAO {
    ...
    public boolean insertVoucher(Voucher v) {
        ...
        try (Connection conn = dbContext.getConnection();
            ...
            if (v.getMax_uses() != null) stmt.setInt(6, v.getMax_uses()); else stmt.setNull(6, Types.INTEGER);
            if (v.getMax_uses_per_user() != null) stmt.setInt(7, v.getMax_uses_per_user()); else stmt.setNull(7, Types.INTEGER);
    ...
    public boolean updateVoucher(Voucher v) {
        ...
        try (Connection conn = dbContext.getConnection();
            ...
            if (v.getMax_uses() != null) stmt.setInt(5, v.getMax_uses()); else stmt.setNull(5, Types.INTEGER);
            if (v.getMax_uses_per_user() != null) stmt.setInt(6, v.getMax_uses_per_user()); else stmt.setNull(6, Types.INTEGER);
