 ...
 * @author nghia
 */
@WebServlet(name = "InventoryLogServlet", urlPatterns = {"/inventorylogservlet"})
public class InventoryLogServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Vector<InventoryLog> logs = logDAO.getAllLogs();
            ...
            e.printStackTrace();
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Error loading inventory logs");
        }
    }
